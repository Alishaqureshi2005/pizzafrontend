...
const API_URL = import.meta.env.VITE_API_URL || 'https://pizzabackend-i6bv.onrender.com/api';
...
adminApi.interceptors.response.use(
  ...
  (error) => {
    ...
    if (error.code === 'ERR_NETWORK') {
      ...
      // Prevent infinite redirect loop by checking current path
...
export const printerApi = {
  ...
  printOrder: (data) => adminApi.post('/printer/settings/print', data),
